...
class TickSlider: UISlider
{
    ...
    override func awakeFromNib()
    {
        ...
        thumbTextLabel.textColor = getColour(withHexadecimalString: "#4B4B4B")
    ...
    override func draw(_ rect: CGRect)
    {
        ...
        for individualIndex in 1...Int(numberOfTicksToDraw)
        {
            ...
            var properColour = getColour(withHexadecimalString: "#E4E4E6")
            //
            //            if individualIndex == 6
            //            {
            //                properColour = getColour(withHexadecimalString: "#E4E4E6")
            //            }
            //            else if individualIndex > 6
            //            {
            //                properColour = getColour(withHexadecimalString: "#60C129")
            //            }
