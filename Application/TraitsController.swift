...
class TraitsController: UIViewController
{
    ...
    @IBAction func traitButton(_ sender: Any)
    {
        if let traitButton = (sender as? ShadowButton)
        {
            ...
            {
                animateSet(forButton: traitButton, backgroundColour: getColour(withHexadecimalString: "#60C129"), shadowColour: getColour(withHexadecimalString: "#3B9A1B"))
            }
            else if traitButton.backgroundColor == getColour(withHexadecimalString: "#60C129")
            {
                animateSet(forButton: traitButton, backgroundColour: getColour(withHexadecimalString: "#E95A53"), shadowColour: getColour(withHexadecimalString: "#D5443B"))
            }
            else
            {
                animateSet(forButton: traitButton, backgroundColour: .white, shadowColour: getColour(withHexadecimalString: "#E1E0E1"))
            }
        }
    }
    ...
    func initialiseButtons(_ withButtons: [ShadowButton])
    {
        for individualButton in withButtons
        {
            ...
            individualButton.initialiseLayer(animateTouches: false, backgroundColour: .white, customBorderFrame: nil, customCornerRadius: nil, shadowColour: getColour(withHexadecimalString: "#E1E0E1").cgColor)
    ...
    @objc func doubleTapped(_ withGesture: UITapGestureRecognizer)
    {
        ...
        if tappedButton.backgroundColor != getColour(withHexadecimalString: "#E95A53")
        {
            animateSet(forButton: tappedButton, backgroundColour: getColour(withHexadecimalString: "#E95A53"), shadowColour: getColour(withHexadecimalString: "#D5443B"))
        }
        else
        {
            animateSet(forButton: tappedButton, backgroundColour: .white, shadowColour: getColour(withHexadecimalString: "#E1E0E1"))
        }
    }
    ...
    func animateSet(forButton: ShadowButton, backgroundColour: UIColor, shadowColour: UIColor)
    {
        ...
        UIView.animate(withDuration: 0.15, animations: {
            ...
            UIView.animate(withDuration: 0.15, animations: {
                ...
                forButton.initialiseLayer(animateTouches: false, backgroundColour: backgroundColour, customBorderFrame: nil, customCornerRadius: nil, shadowColour: shadowColour.cgColor)
                ...
                if backgroundColour ==  getColour(withHexadecimalString: "#60C129")
                {
                ...
                else if backgroundColour == getColour(withHexadecimalString: "#E95A53")
                {
