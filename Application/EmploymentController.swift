...
class EmploymentController: UIViewController
{
    ...
    {
        employmentStatusSegmentedControl.setTitleTextAttributes([.foregroundColor: getColour(withHexadecimalString: "#4B4B4B"), .font: UIFont(name: "SFUIText-Bold", size: 12)!], for: .normal)
